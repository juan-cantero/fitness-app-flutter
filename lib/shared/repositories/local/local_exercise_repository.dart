...
/// Local SQLite implementation of the Exercise repository
/// This class extends the sync-aware repository to provide full exercise management
/// with local storage and synchronization capabilities
class LocalExerciseRepository extends SyncAwareRepository<Exercise> implements IExerciseRepository {
  ...
  Future<List<Exercise>> searchExercises(
    ...
    try {
      ...
      throw repo_exceptions.DatabaseException('Failed to search exercises: $e');
    }
  }
  ...
  Future<List<Exercise>> findByMuscleGroups(
    ...
    try {
      ...
      throw repo_exceptions.DatabaseException('Failed to find exercises by muscle groups: $e');
    }
  }
  ...
  Future<List<Exercise>> findByEquipment(
    ...
    try {
      ...
      throw repo_exceptions.DatabaseException('Failed to find exercises by equipment: $e');
    }
  }
  ...
  Future<List<Exercise>> findSimilarExercises(
    ...
    try {
      ...
      throw repo_exceptions.DatabaseException('Failed to find similar exercises: $e');
    }
  }
  ...
  Future<List<Exercise>> findByCategory(
    ...
    try {
      ...
      throw repo_exceptions.DatabaseException('Failed to find exercises by category: $e');
    }
  }
  ...
  Future<List<Exercise>> getPopularExercises({
    ...
    try {
      ...
      throw repo_exceptions.DatabaseException('Failed to get popular exercises: $e');
    }
  }
  ...
  Future<void> addToCategory(String exerciseId, String categoryId) async {
    ...
    try {
      ...
      throw repo_exceptions.DatabaseException('Failed to add exercise to category: $e');
    }
  }
  ...
  Future<void> removeFromCategory(String exerciseId, String categoryId) async {
    ...
    try {
      ...
      throw repo_exceptions.DatabaseException('Failed to remove exercise from category: $e');
    }
  }
  ...
  Future<List<Category>> getExerciseCategories(String exerciseId) async {
    ...
    try {
      ...
      throw repo_exceptions.DatabaseException('Failed to get exercise categories: $e');
    }
  }
  ...
  Future<List<Exercise>> _getExercisesByIds(List<String> ids) async {
    ...
    try {
      ...
      throw repo_exceptions.DatabaseException('Failed to get exercises by IDs: $e');
    }
  }
}