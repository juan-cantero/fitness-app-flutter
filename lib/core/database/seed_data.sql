...
-- Dumbbell exercises
INSERT OR IGNORE INTO exercises (id, name, description, instructions, created_by, is_public, difficulty_level, exercise_type, primary_muscle_groups, secondary_muscle_groups, equipment_required, movement_pattern, tempo, progressions, safety_notes, calories_per_minute, met_value, tags, is_unilateral, is_compound, requires_spotter) VALUES
('ex_dumbbell_press', 'Dumbbell Chest Press', 'Upper body pressing movement with dumbbells', 'Lie on bench with dumbbells at chest level. Press weights up and together. Lower with control.', 'user_demo_1', TRUE, 'intermediate', 'strength', '["chest", "shoulders", "triceps"]', '["core"]', '["eq_dumbbells"]', 'push', '2-1-2-1', '["ex_incline_dumbbell_press"]', 'Use spotter for heavy weights, control the negative portion', 7.0, 5.0, '["dumbbells", "chest", "compound"]', FALSE, TRUE, TRUE),

('ex_dumbbell_row', 'Dumbbell Row', 'Pulling exercise for back development', 'Hinge at hips, pull dumbbell to hip while squeezing shoulder blade back. Lower with control.', 'user_demo_1', TRUE, 'intermediate', 'strength', '["back", "biceps"]', '["rear_delts", "core"]', '["eq_dumbbells"]', 'pull', '2-1-2-1', '["ex_barbell_row"]', 'Maintain neutral spine, avoid using momentum', 6.0, 4.5, '["dumbbells", "back", "pulling"]', TRUE, TRUE, FALSE),

('ex_goblet_squat', 'Goblet Squat', 'Squat variation holding weight at chest', 'Hold dumbbell at chest. Squat down keeping chest up and elbows inside knees. Drive through heels to stand.', 'user_demo_1', TRUE, 'beginner', 'strength', '["quadriceps", "glutes"]', '["hamstrings", "core", "upper_back"]', '["eq_dumbbells"]', 'squat', '2-1-2-1', '["ex_front_squat"]', 'Keep weight close to body, maintain upright torso', 7.0, 5.5, '["dumbbells", "squat", "goblet"]', FALSE, TRUE, FALSE);

-- Barbell exercises
INSERT OR IGNORE INTO exercises (id, name, description, instructions, created_by, is_public, difficulty_level, exercise_type, primary_muscle_groups, secondary_muscle_groups, equipment_required, movement_pattern, tempo, safety_notes, calories_per_minute, met_value, tags, is_compound, requires_spotter) VALUES
('ex_deadlift', 'Barbell Deadlift', 'King of all exercises - full body pulling movement', 'Stand with barbell over mid-foot. Hinge at hips, grab bar. Drive through heels, extend hips to stand tall.', 'user_demo_1', TRUE, 'advanced', 'strength', '["hamstrings", "glutes", "back"]', '["quadriceps", "traps", "forearms", "core"]', '["eq_barbell", "eq_weight_plates"]', 'hinge', '2-1-3-1', 'Use proper form, progress gradually, consider belt for heavy loads', 8.0, 6.0, '["barbell", "deadlift", "compound"]', TRUE, TRUE),

('ex_squat_barbell', 'Barbell Back Squat', 'Fundamental barbell squatting movement', 'Bar on upper back, feet shoulder-width apart. Squat down keeping chest up. Drive through heels to stand.', 'user_demo_1', TRUE, 'intermediate', 'strength', '["quadriceps", "glutes"]', '["hamstrings", "core", "upper_back"]', '["eq_barbell", "eq_weight_plates"]', 'squat', '3-1-2-1', 'Use safety bars, proper warm-up essential, maintain knee alignment', 9.0, 6.5, '["barbell", "squat", "compound"]', TRUE, TRUE);

-- Cardio exercises
INSERT OR IGNORE INTO exercises (id, name, description, instructions, created_by, is_public, difficulty_level, exercise_type, primary_muscle_groups, secondary_muscle_groups, equipment_required, movement_pattern, calories_per_minute, met_value, tags) VALUES
('ex_treadmill_run', 'Treadmill Running', 'Steady-state cardiovascular exercise', 'Maintain steady pace on treadmill. Focus on proper running form and breathing rhythm.', 'user_demo_2', TRUE, 'intermediate', 'cardio', '["legs"]', '["cardiovascular", "core"]', '["eq_treadmill"]', 'gait', 12.0, 8.0, '["cardio", "running", "endurance"]'),

('ex_jump_rope', 'Jump Rope', 'High-intensity cardio exercise', 'Jump over rope with both feet, maintaining rhythm. Land softly on balls of feet.', 'user_demo_2', TRUE, 'intermediate', 'cardio', '["calves"]', '["cardiovascular", "coordination"]', '["eq_jump_rope"]', 'gait', 15.0, 12.0, '["cardio", "hiit", "coordination"]'),

('ex_burpee', 'Burpee', 'Full-body high-intensity exercise', 'Squat down, kick back to plank, do push-up, jump feet to hands, jump up with arms overhead.', 'user_demo_1', TRUE, 'advanced', 'cardio', '["full_body"]', '["cardiovascular"]', '["eq_bodyweight"]', 'compound', 18.0, 15.0, '["bodyweight", "hiit", "full_body"]');
